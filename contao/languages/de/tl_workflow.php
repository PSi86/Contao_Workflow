...
$GLOBALS['TL_LANG']['tl_workflow']['sourceFile']    = ['Quelldatei', 'CSV- oder XLSX-Datei. Nach dem Auswählen speichern, damit die Spalten erkannt werden.'];
$GLOBALS['TL_LANG']['tl_workflow']['sourceSheet']   = ['Tabellenblatt', 'Welches Blatt der Mappe ausgelesen wird (leer = aktives Blatt).'];
$GLOBALS['TL_LANG']['tl_workflow']['headerRow']     = ['Kopfzeile', 'Zeilennummer mit den Spaltenüberschriften (Standard 1).'];
$GLOBALS['TL_LANG']['tl_workflow']['emailField']    = ['E-Mail-Spalte', 'Spalte mit der E-Mail-Adresse (Empfänger der Einladung).'];
$GLOBALS['TL_LANG']['tl_workflow']['inputFields']   = ['Anzeige-Felder (Input)', 'Spalten, die im Formular vorausgefüllt und schreibgeschützt angezeigt werden.'];
...
$GLOBALS['TL_LANG']['tl_workflow']['master']        = ['Briefkopf-Vorlage', 'Briefkopf/Master (Vorlage, Logo, Variablen). Wird unter „Briefkopf-Vorlagen" gepflegt.'];
...
$GLOBALS['TL_LANG']['tl_workflow']['questions'] = ['Antwortfelder', 'Felder, die die Person im Formular ausfüllt. „Neu" legt ein Feld an, „Bearbeiten" öffnet es im Dialog.'];
