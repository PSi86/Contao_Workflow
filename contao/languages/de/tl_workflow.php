...
$GLOBALS['TL_LANG']['tl_workflow']['pdfSignatureLocationSource'] = ['Quelle für den Ort', 'Woher der Ort in der Unterschriftszeile kommt: aus einer Spalte der Quelldatei (je Teilnehmer verschieden, z. B. der Wohnort) oder aus einer Variablen des zugeordneten Briefpapiers (für alle gleich, z. B. der Vereinssitz).'];
$GLOBALS['TL_LANG']['tl_workflow']['pdfSignatureLocationSourceOptions'] = ['data' => 'Datenfeld aus der Quelldatei', 'var' => 'Briefpapier-Variable'];
...
$GLOBALS['TL_LANG']['tl_workflow']['pdfSignatureLocationVar'] = ['Briefpapier-Variable für den Ort', 'Variable des zugeordneten Briefpapiers (z. B. „Ort“), deren Wert als Ort in der Unterschriftszeile des PDFs gedruckt wird. Leer = kein Ort. Die Auswahl zeigt die Variablen des gespeicherten Briefpapiers – ein gerade gewechseltes Briefpapier erscheint hier erst nach dem Speichern.'];
$GLOBALS['TL_LANG']['tl_workflow']['pdfFileName'] = ['PDF-Dateiname', 'Muster für den Dateinamen des PDFs, Platzhalter und {{Insert-Tags}} erlaubt, z. B. Verzicht_##data_name##_##data_vorname##. Umlaute und andere Zeichen bleiben erhalten; Leerzeichen und Satzzeichen werden zu „_“. Bei Namensgleichheit wird automatisch ein kurzer Token angehängt. Leer = Token.'];
