...
$GLOBALS['TL_LANG']['tl_workflow_question']['description']  = ['Beschreibung', 'Optionaler Hinweistext, der nur im Formular unter der Überschrift angezeigt wird (nur wenn nicht leer). Er erscheint nie im Dokument.'];
...
$GLOBALS['TL_LANG']['tl_workflow_question']['options']      = ['Optionen', 'Auswahlmöglichkeiten. „Wert“ wird gespeichert, „Options-Text“ wird angezeigt, „Dokument-Text“ erscheint im Dokument (leer = Options-Text gilt wörtlich).'];
