...
$GLOBALS['TL_LANG']['tl_workflow_rule']['pdfBody']    = ['Brieftext', 'Text, der ins PDF kommt, wenn diese Regel greift. Überschrift, Logo, Unterschrift und Footer kommen aus dem Workflow bzw. Briefkopf. Platzhalter: ##data_<feld>## (Spalten inkl. Antwortfelder, z. B. ##data_verzicht##), ##var_<variable>## (Briefkopf-Variablen, z. B. ##var_jahr##, ##var_verein##), ##email##.'];
