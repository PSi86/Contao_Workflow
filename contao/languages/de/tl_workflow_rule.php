...
$GLOBALS['TL_LANG']['tl_workflow_rule']['text_legend'] = 'Brieftext';

$GLOBALS['TL_LANG']['tl_workflow_rule']['title']      = ['Bezeichnung', 'Name der Regel, z. B. „Zustimmung" oder „Ablehnung" (nur zur Übersicht).'];
$GLOBALS['TL_LANG']['tl_workflow_rule']['isDefault']  = ['Standardtext', 'Dieser Text gilt immer, wenn keine andere Regel zutrifft (Sonst-Fall). Bei aktivierter Option entfallen die Bedingungen. Es darf nur EINE Standardtext-Regel geben – stellen Sie sie ans Ende.'];
...
$GLOBALS['TL_LANG']['tl_workflow_rule']['pdfBody']    = ['Brieftext', 'Text, der ins PDF kommt, wenn diese Regel greift. Überschrift, Logo, Unterschrift und Footer kommen aus dem Workflow bzw. Briefpapier. Platzhalter: ##data_<feld>## (Spalten inkl. Antwortfelder, z. B. ##data_verzicht##), ##var_<variable>## (Briefpapier-Variablen, z. B. ##var_jahr##, ##var_verein##), ##email##.'];
...
$GLOBALS['TL_LANG']['tl_workflow_rule']['new']    = ['Neue Regel', 'PDF-Regel hinzufügen.'];
