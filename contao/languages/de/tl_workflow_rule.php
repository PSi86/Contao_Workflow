...
$GLOBALS['TL_LANG']['tl_workflow_rule']['pdfBody']    = ['Dokument-Text', 'Text, der ins Dokument kommt, wenn diese Regel greift. Überschrift, Logo, Unterschrift und Footer kommen aus dem Workflow bzw. Briefpapier. Platzhalter: ##data_<feld>## (Spalten inkl. Formularfelder, z. B. ##data_verzicht##), ##letterhead_<variable>## (Briefpapier-Variablen, z. B. ##letterhead_verein##, ##letterhead_ort##), ##system_year## / ##system_today## (aktuelles Jahr/Datum), ##email##. {{Insert-Tags}} sind ebenfalls erlaubt. Formatierung: [b]fett[/b], [i]kursiv[/i], [u]unterstrichen[/u].'];
