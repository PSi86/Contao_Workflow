...
$GLOBALS['TL_LANG']['tl_workflow_master']['title_legend']  = 'Titel';
...
$GLOBALS['TL_LANG']['tl_workflow_master']['masterTemplate'] = ['Layout-Vorlage (Template)', 'Master-Template mit Kopf/Fuß/Unterschrift-Layout, z. B. pdf_master. Die passenden PDF-Variablen werden nach dem Speichern vorgeschlagen.'];
...
$GLOBALS['TL_LANG']['tl_workflow_master']['delete'] = ['Löschen', 'Briefpapier löschen.'];
$GLOBALS['TL_LANG']['tl_workflow_master']['show']   = ['Details', 'Briefpapier-Details anzeigen.'];
