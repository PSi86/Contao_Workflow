...
$GLOBALS['TL_LANG']['tl_workflow']['sourceFile']    = ['Source file', 'CSV or XLSX file. Save after selecting so the columns are detected.'];
$GLOBALS['TL_LANG']['tl_workflow']['sourceSheet']   = ['Worksheet', 'Which sheet of the workbook to read (empty = active sheet).'];
$GLOBALS['TL_LANG']['tl_workflow']['headerRow']     = ['Header row', 'Row number that holds the column headers (default 1).'];
...
$GLOBALS['TL_LANG']['tl_workflow']['master']        = ['Letterhead', 'Letterhead/master (template, logo, variables). Maintained under "Letterhead templates".'];
