...
$GLOBALS['TL_LANG']['tl_workflow_rule']['pdfBody']    = ['Body text', 'Text used in the PDF when this rule applies. Heading, logo, signature and footer come from the workflow/letterhead. Placeholders: ##column## (incl. answer fields), ##datum##, ##email## and PDF variables (##Jahr##, ##Verein## …).'];
