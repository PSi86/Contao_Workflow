...
7. **Datendownload** öffnet den Dialog: Excel (XLSX), CSV und/oder die PDFs ankreuzen – die
   Verpackung folgt der Auswahl (eine Datei bleibt nackt, mehreres kommt als ZIP).
